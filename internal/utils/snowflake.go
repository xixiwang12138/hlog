...
//
//func init() {
//	curNode, definederr := snowflake.NewNode(1)
//	if definederr != nil {
//		log.Println(definederr)
//		curNode, _ = snowflake.NewNode(1) //重试
//	}
//	node = curNode
//}
//
...
//func SnowflakeId() string {
//	node, definederr := snowflake.NewNode(1)
//	if definederr != nil {
//		log.Println(definederr)
//		node, _ = snowflake.NewNode(1) //重试
//	}
//	return strconv.FormatInt(int64(node.Generate()), 10)
//}
